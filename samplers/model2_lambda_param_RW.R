...
lambdaModel2_param <- function(ssm,N,L,N.mcmc.param=20,init=NULL,seed=NULL,rw_scale=c(0.1,0.1,0.1),rho.init=NULL,phi.init=NULL,delta.init=NULL,checkpoint.name=NULL){
